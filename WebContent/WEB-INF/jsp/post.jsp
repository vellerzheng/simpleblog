...
<body>
    ...
    <div class="container">
        <div class="row">
            <p><h3>撰写新的博客</h3><p>
            <form action="<c:url value="/post"/>" method="post" id="editorForm" name="upfile" onsubmit="return validate_post_blog(this)">
                ...
                <div class="row col-xs-4" >
                    <select name="editorCategory" class="selectpicker show-tick form-control" >
                ...
                <input type="submit" class="btn btn-sm btn-success" value="发布"/>
            </form>
        </div>
    </div>
